...
namespace Finn.MVC.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
	        ...
	        if (user.Email == ConfigurationManager.AppSettings["demoLogin"])
	        {
				ViewBag.errorMessage = "В демонстрационном режиме нельзя настраивать параметры учетной записи. Зарегистрируйтесь.";
		        return View("Error");
	        }
